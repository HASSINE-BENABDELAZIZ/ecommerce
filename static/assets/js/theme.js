...
var totalOrderInit = function totalOrderInit() {
  var ECHART_LINE_TOTAL_ORDER = '.echart-default-total-order'; //
  // ─── TOTAL ORDER CHART ──────────────────────────────────────────────────────────
  //
  ...
  if ($echartLineTotalOrder) {
    ...
    $.ajax({
      url: "/stat/month",
      type: 'get',
      data: {"chart_weeks": [0, 0, 0, 0], "chart_data": [0, 0, 0, 0]},
      success: function (res) {
...
var weeklySalesInit = function weeklySalesInit() {
  ...
  if ($echartBarWeeklySales) {
    ...
    $.ajax({
      url: "/stat/week",
            type: 'get',
            data: {"chart": [0, 0, 0, 0, 0, 0, 0]},
            success: function (res) {
                var userOptions = utils.getData($echartBarWeeklySales, 'options');
                var data = res.chart; // Max value of data
